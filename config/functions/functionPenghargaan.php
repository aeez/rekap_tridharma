...
function detail($id)
{
    ...
    global $conn;
    $result = mysqli_query($conn, "SELECT * FROM tb_penghargaan WHERE id_penghargaan = '$id'");
...
function tambah($request)
{
    ...
    $institusi = htmlspecialchars($request['institusi']);
    ...
    $query = "INSERT INTO tb_penghargaan VALUES
            (null,'$jenis_penghargaan','$institusi','$tahun','$link_file','$id_dosen')";
...
function ubah($request)
{
    ...
    $query = "UPDATE tb_penghargaan SET
...
function hapus($id)
{
    ...
    mysqli_query($conn, "DELETE FROM tb_penghargaan WHERE id_penghargaan = $id");
