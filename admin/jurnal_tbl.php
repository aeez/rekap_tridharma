...
$jurnal = query("SELECT DISTINCT nama,nidn,tb_jurnal.id_dosen FROM tb_jurnal INNER JOIN tb_dosen ON tb_jurnal.id_dosen=tb_dosen.id_dosen");
?>
            ...
            <div class="container py-4">
              ...
              <div class="row welcome p-2 justify-content-center">
                <div class="col-11 col-lg-12 welcome-text">
                  <h3 class="fw-bold">Luaran Hasil (Jurnal)</h3>
                </div>
              </div>
                    ...
                    <div class="row button-section mb-3">
                      <div class="col-12">
                        <div class="button-tambah-wrapper">
                          <a href="jurnal_tambah.php" class="btn btn-blue">Tambah Jurnal</a>
                        </div>
                      </div>
                    </div>
                          ...
                          <table class="table" id="data-table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?= $dataJurnal['nidn']; ?></td>
                                <td><?= $dataJurnal['nama']; ?></td>
                                <td class="button">
                                  <a href="jurnal_detail.php?id_dosen=<?= $dataJurnal['id_dosen']; ?>" class="btn btn-blue">Detail</a>
                                </td>
                              </tr>
                                <?php endforeach; ?>
                            </tbody>
