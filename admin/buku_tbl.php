            ...
            <div class="container py-4">
              ...
              <div class="row welcome p-2 justify-content-center">
                <div class="col-11 col-lg-12 welcome-text">
                  <h3 class="fw-bold">Luaran Hasil (Buku)</h3>
                </div>
              </div>
                    ...
                    <div class="row button-section mb-3">
                      <div class="col-12">
                        <div class="button-tambah-wrapper">
                          <a href="buku_tambah.php" class="btn btn-blue">Tambah Buku</a>
                        </div>
                      </div>
                    </div>
                          ...
                          <table class="table" id="data-table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?= $dataBuku['nama']; ?></td>
                                <td class="button">
                                  <a href="buku_detail.php?id_dosen=<?= $dataBuku['id_dosen']; ?>" class="btn btn-blue">Detail</a>
                                </td>
                              </tr>
                                <?php endforeach; ?>
                            </tbody>
