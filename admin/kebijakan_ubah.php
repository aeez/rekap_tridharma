...
$dataKebijakan = query("SELECT * FROM tb_kebijakan WHERE id_penghargaan = $id")[0];
    ...
    if (ubah($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'Kebijakan_ubah.php';
            </script>
        ";
    }
}
                        ...
                        <div class="form-ubah">
                          ...
                          <form action="" method="POST">
                            <div class="row justify-content-center">
                              <div class="col-lg-12">
                                <input type="hidden" name="id_penghargaan" value="<?= $dataKebijakan['id_penghargaan']; ?>">
                                <div class="mb-3">
                                  ...
                                  <input
                                    ...
                                    value="<?= $dataKebijakan['jenis_penghargaan']; ?>"
                                    required
                                  />
                                </div>
                                ...
                                <div class="mb-3">
                                  ...
                                  <input
                                    ...
                                    id="link_file"
                                    name="link_file"
                                    value="<?= $dataKebijakan['link_file']; ?>"
                                    required
                                  />
                                </div>
                                <input type="hidden" name="id_dosen" value="<?= $dataKebijakan['id_dosen']; ?>">
                              </div>
                              <div class="">
                                  <button
                                    type="submit"
